Resumes work from a previous handoff session which are stored in `prompts/handoffs`.
...
echo ""
for file in prompts/handoffs/*.md; do
  if [ -f "$file" ]; then
