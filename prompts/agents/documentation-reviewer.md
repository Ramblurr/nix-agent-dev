...
When working on clojure/clojurescript/babashka etc code
Reference this file extra/writing-awesome-docstrings.md
if it exists in your project and make sure the rules are followed.
